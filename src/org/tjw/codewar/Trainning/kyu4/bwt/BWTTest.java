...
public class BWTTest {
    public static void main(String[] args) throws Throwable {
        BufferedReader reader = new BufferedReader(new FileReader("E:\\glib\\algorithm\\src\\org\\tjw\\codewar\\Trainning\\kyu4\\bwt\\data\\data01"));
        String temp;
...
//            if("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWSYZ ./(<>):+'—_,;".indexOf(ch) == -1)
